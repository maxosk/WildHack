...
<body>
    ...
    <section class="sign-in container column">
        ...
        <h4 class="sign-in__title title-1">Авторизация</h4>

        <form action="${"/login"}" method="post" class="sign-in__form column">
            ...
            <button  type="submit" value="Sign In" class="sign-in__form__button button">Войти</button>
